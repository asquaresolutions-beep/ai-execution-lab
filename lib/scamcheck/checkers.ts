...
export interface Checker {
  ...
  /** Matching in-depth guide on the A Square Solutions blog (authority cluster). */
  guide?: { url: string; title: string }
}

const G = 'https://asquaresolution.com/blog/'
...
export const CHECKERS: Checker[] = [
  {
    ...
    guide: { url: G + 'whatsapp-scam-detection-guide/', title: 'WhatsApp Scam Detection Guide' },
    faqs: [
  ...
  },
  {
    ...
    guide: { url: G + 'courier-parcel-scam-texts/', title: 'Courier & Parcel Scam Texts' },
    faqs: [
  ...
  },
  {
    ...
    guide: { url: G + 'upi-refund-qr-code-scams/', title: 'UPI Refund & QR-Code Scams' },
    faqs: [
  ...
  },
  {
    ...
    guide: { url: G + 'how-to-identify-phishing-emails/', title: 'How to Identify Phishing Emails' },
    faqs: [
  ...
  },
  {
    ...
    guide: { url: G + 'ai-voice-deepfake-scams/', title: 'AI Voice & Deepfake Scams' },
    faqs: [
  ...
  },
  {
    ...
    guide: { url: G + 'is-this-link-safe-how-to-check-a-url/', title: 'Is This Link Safe? How to Check a URL' },
    faqs: [
