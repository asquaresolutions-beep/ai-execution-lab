...
export const ar: Messages = {
  ...
  dash: {
    ...
    apiTitle: 'الوصول إلى الواجهة البرمجية',
    apiKey: 'مفتاح API الخاص بك',
    apiPlan: 'الخطة',
    apiPerMinute: 'طلبات / دقيقة',
    apiMonthly: 'الحد الشهري',
  ...
  timeline: {
    heading: 'سجل الثقة',
    verified: 'تم توثيق ملكية النطاق',
    reverified: 'أُعيد التحقق',
    band: 'تغيّر مستوى الثقة',
    score: 'تغيّرت درجة الثقة',
    ssl: 'تغيّرت حالة SSL',
    dns: 'تغيّرت سجلات DNS',
    empty: 'لا يوجد سجل إضافي بعد.',
  },

  cert: {
    title: 'شهادة التحقق',
    subtitle: 'إثبات رسمي لتوثيق النطاق بواسطة TrustSeal.',
    certificateId: 'معرّف الشهادة',
    domainLabel: 'النطاق',
    trustLevel: 'مستوى الثقة',
    trustScore: 'درجة الثقة',
    verifiedOn: 'تاريخ التحقق',
    reverifyDue: 'موعد إعادة التحقق',
    verificationUrl: 'رابط التحقق',
    fingerprint: 'بصمة الشهادة (SHA-256)',
    signature: 'التوقيع',
    issuedBy: 'صادرة عن',
    issuedByBody: 'صادرة عن TrustSeal، أحد منتجات A Square Solutions. يمكن التحقق من الأصالة عبر رابط التحقق أو بإعادة حساب البصمة على حقول الشهادة.',
  ...
  network: {
    heading: 'مركز القيادة الخاص بك',
    subheading: 'لوحة عمل واحدة لكل ما تتحقق منه: كل نطاق، وحالة الثقة المباشرة، وكود تضمين الشارة، وتنبيهات المراقبة — في مكان واحد.',
